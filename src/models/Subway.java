...
/**
 * The type Subway represent the entire subway system, with all the stations and connections.
 */
public class Subway
{
    ...
    /**
     * Add a station to the subway system.
     *
    ...
    /**
     * Whether the subway system has a station or not.
     *
     * @param stationName the station name
     * @return whether the subway system has the station or not
     */
     ...
     *
     * @param station1Name the first station's name
     * @param station2Name the next station's name
    ...
    /**
     * Gets directions to go from a station to another.
     *
    ...
    /**
     * Whether the subway system has a connection between two stations or not.
     *
     * @param station1Name the first station's name
     * @param station2Name the second station's name
     * @param lineName     the line name
     * @return whether the subway system has a connection between two stations or not
     */
